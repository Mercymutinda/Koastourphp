...
<div class="space-extra2-top space-extra2-bottom" data-bg-src="<?= $basePath ?>assets/img/bg/tree.jpg">
  <div class="container">
    <div class="row flex-row-reverse justify-content-center align-items-center">
      ...
      <div class="col-lg-6">
        <div>
          <form action="<?= \yii\helpers\Url::to(['site/contact']) ?>" method="POST"
            ...
            <div class="row">
              <div class="col-12 form-group">
                <input type="text" class="form-control" name="name" placeholder="Full name / Organization" required />
              ...
              <div class="form-group col-12">
                <textarea name="message" cols="30" rows="3" class="form-control" placeholder="Your Message"
                  required></textarea>
